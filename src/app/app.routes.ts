...
export const routes: Routes = [
...

  {
    ...
    children: [
      ...
      { path: 'plantillas-correo', canActivate: [permissionGuard], data: { permission: 'configuracion-email:view' },
        loadChildren: () => import('./features/plantillas-correo/plantillas-correo.routes').then((m) => m.PLANTILLAS_CORREO_ROUTES) },
      { path: 'menu-del-dia', canActivate: [permissionGuard], data: { permission: 'configuracion-email:update' },
